...
import type { ApplicationTabs } from './types/applicationTabs'
import type { TestingObject } from './types/testingObject'

interface CreateApplicationSliceState {
...
const initialState: CreateApplicationSliceState = {
  currentStep: 0,
  activeTab: 'general',
